...
<div class="container">
    ...
    <!-- Form Edit Transaksi -->
    <form action="{{ route('dashboard.cashier.update', $transaksi->id) }}" method="POST" id="transaksi-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="{{ old('nama_pelanggan', $transaksi->nama_pelanggan) }}" placeholder="Masukkan Nama Pelanggan" required>
        ...
        <div class="form-group mb-3">
            ...
            <select name="metode_pembayaran" class="form-control" id="metode_pembayaran" onchange="toggleBayarButton()" required>
                ...
                <option value="qr" {{ old('metode_pembayaran', $transaksi->metode_pembayaran) == 'qr' ? 'selected' : '' }}>QR Payment</option>
            </select>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" name="total_harga" id="total_harga" value="{{ old('total_harga', $transaksi->total_harga) }}" readonly>
            </div>
        </div>
        ...
        <!-- Tombol Simpan -->
        <button type="submit" class="btn btn-primary" id="submitButton">update Transaksi</button>
